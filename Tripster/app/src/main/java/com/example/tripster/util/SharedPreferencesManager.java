...
public class SharedPreferencesManager {
    ...
    public static void saveUserInfo(Context context, String email, UserType userType, Long user_id,Long person_id) {
    ...
    public static User getUserInfo(Context context) {
        ...
        return new User( userid, email,  UserType.valueOf(userRole),personId);
    }
